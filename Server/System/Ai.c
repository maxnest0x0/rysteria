...
static void system_for_each(EntityIdx entity, void *simulation)
{
    ...
    case rr_mob_id_pectinodon:
        if (mob->rarity >= rr_rarity_id_epic) // Change to rare, set as epic because due to high body damage may be a pain at lower rarities before speed progressively diminishes.
            tick_ai_aggro_default(entity, this, RR_PLAYER_SPEED *
                                  (1.4 - mob->rarity * 0.09));
        else
            tick_ai_neutral_default(entity, this, RR_PLAYER_SPEED *
